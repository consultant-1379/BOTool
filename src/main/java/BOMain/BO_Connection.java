...
public class BO_Connection {
	...
	public String queryMethod(String method, String link, String format) throws Exception {
		return query1(method, link, format, token, null);
	}
	
	public String queryPutMethod(String method, String link, String format, String content) throws Exception {
		return queryTest(method, link, format, token, content);
	}
	...
	public void connect(String username, String password, String auth) throws Exception {
		...
		String body = "<attrs xmlns=\"http://www.sap.com/rws/bip\">" + "<attr name=\"userName\" type=\"string\">"
				+ username + "</attr>" + "<attr name=\"password\" type=\"string\">" + password + "</attr>"
				+ "<attr name=\"auth\" type=\"string\">" + auth + "</attr>" + "</attrs>";
	...
	public static String query(String method, String link, String format, String token, String content)
			throws Exception {
		...
		try {
			...
			if (conn.getResponseCode() != 200) {
				throw new Exception("HTTP Error Code: " + conn.getResponseCode() + " " + conn.getResponseMessage());
			}
	...
	public static String query1(String method, String link, String format, String token, String content)
			throws Exception {
		HttpURLConnection conn = null;
		try {
			URL url = new URL(link);
	...
	public static String queryTest(String method, String link, String format, String token, String content)
			throws Exception {
		HttpURLConnection conn = null;
		try {
			URL url = new URL(link);
